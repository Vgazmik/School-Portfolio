...
typedef struct{
    ...
    u_int32_t from_IP, to_IP;  // Ultimate destination, not the relay
    ...
    u_int16_t from_Port, to_Port; // Ultimate source & destination.  Not relay.
    u_int32_t trueFromIP, trueToIP; // AWS may change public IP vs private IP
